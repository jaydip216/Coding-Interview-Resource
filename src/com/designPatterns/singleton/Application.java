...
public class Application {
    ...
    private static void exampleSerialization() throws IOException, ClassNotFoundException {
        ...
        SerializedSingleton serializableSingleton = SerializedSingleton.getInstance();
        ...
        SerializedSingleton deserializedInstance = (SerializedSingleton) objectInputStream2.readObject();
